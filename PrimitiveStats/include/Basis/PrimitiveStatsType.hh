...
public:
  ...
  virtual void CopyClone(PrimitiveStats* primstat);
...
public:
  ...
  /*    UNRESOLVED EXTERNAL!!!!!!
        virtual void CopyClone(DistributionStats *dst);
...
virtual void CopyClone(GeneralDistributionStats *gdst);
virtual Identify* Clone();
virtual ostream& print(ostream& out) const;
virtual bool EncodeThis(CommBuffer& buffer);
virtual bool DecodeThis(CommBuffer& buffer);
...
virtual void CopyClone(EvenDistributionStats *edst);
virtual Identify* Clone();
virtual ostream& print(ostream& out) const;
virtual bool EncodeThis(CommBuffer& buffer);
virtual bool DecodeThis(CommBuffer& buffer);
...
public:
  ...
  virtual void CopyClone(GeneralDistributionStatsExcept *gdste);
  virtual Identify* Clone();
  virtual ostream& print(ostream& out) const;
  virtual bool EncodeThis(CommBuffer& buffer);
  virtual bool DecodeThis(CommBuffer& buffer);
...
public:
  ...
  virtual void CopyClone(EvenDistributionStatsExcept *edste);
  virtual Identify* Clone();
  virtual ostream& print(ostream& out) const;
  virtual bool EncodeThis(CommBuffer& buffer);
  virtual bool DecodeThis(CommBuffer& buffer);
